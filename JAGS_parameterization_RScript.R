...
# load data files
AGHY_subplot_dat<- read.csv("AGHY_subplot_dat.csv")
AGHY_plot_dat <- read.csv("AGHY_plot_dat.csv")
survival_known <- read.csv("survival_known.csv")
survival_unk_sbplt <- read.csv("survival_unk_sbplt.csv")
survival_plot <- read.csv("survival_plot.csv")
seedmass_dat <- read.csv("seedmass_dat.csv")
infs_dat <- read.csv("infs_dat.csv")
total_plants_infs <- read.csv("total_plants_infs.csv")
infs_unk_stacked <- read.csv("infs_unk_stacked.csv")
flowering_individuals <- read.csv("flowering_individuals.csv")
flowering_plts <- read.csv("flowering_plts.csv")
flowering_sbplts <- read.csv("flowering_sbplts.csv")
linreg_dat <- read.csv("linreg_dat.csv")
rec_final<- read.csv("rec_final.csv")
rec_plot_final<- read.csv("rec_plot_final.csv")
survival_dat2 <- read.csv("survival_dat2.csv")
vtrans_dat <- read.csv("vtrans_dat.csv")

### split the recruitment data frame up into two, that are the correct lengths for the rec estimate year t+1
...
jag.data<-list(N.trt=length(levels(AGHY_subplot_dat$water)),
